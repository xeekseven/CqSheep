#pragma checksum "D:\codes\CqSheep\RazorSamples\CqSheep.RazorSample.Host\Views\Admin\Overview.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f68f50ad0accb5b9ff052c2e789d6b7a2c02f7ad"
// <auto-generated/>
...
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Admin/Overview.cshtml", typeof(AspNetCore.Views_Admin_Overview))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f68f50ad0accb5b9ff052c2e789d6b7a2c02f7ad", @"/Views/Admin/Overview.cshtml")]
    ...
    public class Views_Admin_Overview : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "D:\codes\CqSheep\RazorSamples\CqSheep.RazorSample.Host\Views\Admin\Overview.cshtml"
...
#line hidden
    ...
    <div class=""flex-row flex-main-start flex-align-center flex-nowarp statistics-container"">
        <div class=""flex-column flex-main-center flex-align-center chart-overview"" >
            <div>
                IP 访问量
            </div>
            <div>
            ...
            <canvas id=""div-ip"" style=""position: absolute;"">
    ...
    <div class=""flex-row flex-main-start flex-align-center main-stat-container"">
        <div class=""flex-column flex-main-start flex-align-center main-left"">
            ...
            <div class=""flex-row flex-main-center fl");
            WriteLiteral(@"ex-align-center main-left-selector"">
...
");
            WriteLiteral(@"    .main-left-selector{
...
　　　　});
 ...
 ");
            WriteLiteral(@"       var myChart = echarts.init(document.getElementById('chart-pie'));
        option = {
            title : {
                text: '某站点用户访问来源',
                subtext: '纯属虚构',
    ...
    function drawCurve(id){
        ...
        ctx.moveTo(0,h);
        rpoints = []
        b =  (Math.abs(f(c.width-1)) * 2) / (h * 1.0 )
        for(var i =0;i<c.width;i++){
            let y = f(i)
            //max = y > max ? y : max
            ctx.lineTo(i,transY(y,h,b));
        }
